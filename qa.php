...
<!-- Header -->
<header class="w3-container w3-black w3-center" style="padding:100px 16px"><fieldset class="field"> <p class="tab1"> Home > Get Started > <b>Empathy (Quizzes and Assessment)</b> ></p></fieldset>
</header>
