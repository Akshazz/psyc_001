...
<div class="mb-2">
 <form action="" method="post">
  ...
  <div class="question-slide" style="display: none;">
    ...
    <textarea class="form-control" name="answer1" id="answer1" rows="4" cols="50" placeholder="Enter your answer here!" ></textarea>
    ...
    <textarea class="form-control" name="answer2" id="answer2" rows="4" cols="50" placeholder="Enter your answer here!" ></textarea>
    <div class="form-text">Please answer the question above.</div>
    </div>
    ...
    <textarea class="form-control" name="answer3" id="answer3" rows="4" cols="50" placeholder="Enter your answer here!" ></textarea>
    <div class="form-text">Please answer the question above.</div>
    </div>
    ...
    <button type="submit" class="btn btn-dark" id="submitButton" onclick="checkText()"> Submit Now! </button>
